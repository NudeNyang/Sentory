...
public sealed class SlackDropTargetLocatorTests
{
    [Fact]
    public void FindsVisibleSlackWindowContainingCursor()
    {
    ...
    [Fact]
    public void RejectsCursorOutsideSlackWindow()
    {
        var native = new FakeNative();
        var locator = new SlackDropTargetLocator(native, native, native);
    ...
    [Fact]
    public void RejectsSlackWindowWithoutRenderer()
    {
