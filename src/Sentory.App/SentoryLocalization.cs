...
internal static class SentoryLocalization
{
    ...
    private static IReadOnlyDictionary<string, LocalizedText> CreateTexts()
    {
        var entries = new LocalizedText[]
        {
            ...
            L("ComputerSyncDescription", "OneDrive, Google Drive 또는 MEGA가 동기화하는 폴더를 선택합니다", "Choose a folder synced by OneDrive, Google Drive, or MEGA", "OneDrive、Google Drive、MEGA が同期するフォルダーを選択します", "选择由 OneDrive、Google Drive 或 MEGA 同步的文件夹"),
