...
internal static class SentoryLocalization
{
    ...
    private static IReadOnlyDictionary<string, LocalizedText> CreateTexts()
    {
        var entries = new LocalizedText[]
        {
            ...
            L("AutoFavoriteDescription", "같은 링크나 사진을 설정한 횟수만큼 복사하면 즐겨찾기에 추가합니다", "Add a link or photo to favorites after copying it the selected number of times", "同じリンクや写真を設定した回数コピーするとお気に入りに追加します", "同一链接或图片复制达到设定次数后自动收藏"),
            L("AutoFavoriteOff", "사용 안 함", "Disabled", "使用しない", "不使用"),
            L("AutoFavoriteCopyCountFormat", "{0}회 복사 후 추가", "Add after {0} copies", "{0}回コピー後に追加", "复制 {0} 次后收藏"),
            ...
            L("AutoFavoriteSavedFormat", "{0}회 복사하면 자동으로 즐겨찾기에 추가합니다.", "Items will be added to favorites after {0} copies.", "{0}回コピーすると自動的にお気に入りへ追加します。", "复制 {0} 次后将自动添加到收藏。"),
