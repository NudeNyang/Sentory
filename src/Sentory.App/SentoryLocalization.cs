...
internal static class SentoryLocalization
{
    ...
    private static IReadOnlyDictionary<string, LocalizedText> CreateTexts()
    {
        var entries = new LocalizedText[]
        {
            ...
            L("SyncAutomaticLocationFormat", "감지된 {0} 위치를 사용하거나 다른 동기화 폴더를 직접 선택하세요", "Use the detected {0} location or choose another synced folder", "検出された {0} の場所を使用するか、別の同期フォルダーを直接選択してください", "使用检测到的 {0} 位置，或直接选择其他同步文件夹"),
            L("SyncProviderSelectionDescription", "감지된 저장 위치를 선택하거나 다른 동기화 폴더를 직접 선택하세요", "Choose a detected storage location or another synced folder", "検出された保存場所を選択するか、別の同期フォルダーを直接選択してください", "选择检测到的存储位置，或直接选择其他同步文件夹"),
            L("SyncAutomaticLocationUnavailable", "클라우드 위치를 자동으로 찾지 못했습니다. 아래에서 동기화 폴더를 선택하세요", "No cloud location was found automatically. Choose a synced folder below", "クラウドの場所を自動検出できませんでした。下から同期フォルダーを選択してください", "未能自动找到云端位置，请在下方选择同步文件夹"),
            L("SelectSyncFolder", "다른 폴더 직접 선택", "Choose another folder", "別のフォルダーを直接選択", "直接选择其他文件夹"),
            L("ChooseSyncFolder", "동기화 폴더 선택", "Choose sync folder", "同期フォルダーを選択", "选择同步文件夹"),
            L("ChangeSyncFolder", "폴더 변경", "Change folder", "フォルダーを変更", "更改文件夹"),
            L("ChooseSyncFolderDescription", "클라우드 데스크톱 앱이 다른 컴퓨터와 동기화하는 폴더를 선택하세요", "Choose a folder that your cloud desktop app syncs with other computers", "クラウドデスクトップアプリが他のコンピューターと同期するフォルダーを選択してください", "请选择云桌面应用与其他电脑同步的文件夹"),
            L("SyncFolderNotSelected", "동기화 폴더를 선택하지 않았습니다", "No sync folder selected", "同期フォルダーが選択されていません", "尚未选择同步文件夹"),
            L("SyncFolderSaved", "컴퓨터 간 동기화를 켰습니다.", "Computer sync is enabled.", "コンピューター間同期をオンにしました。", "已开启电脑间同步。"),
            L("SyncAutomaticFolderSavedFormat", "{0}에 Sentory 폴더를 만들고 동기화를 시작했습니다.", "Created the Sentory folder in {0} and started syncing.", "{0} に Sentory フォルダーを作成して同期を開始しました。", "已在 {0} 中创建 Sentory 文件夹并开始同步。"),
            L("SyncEnabledSaved", "컴퓨터 간 동기화를 켰습니다.", "Computer sync is enabled.", "コンピューター間同期をオンにしました。", "已开启电脑间同步。"),
            L("SyncDisabledSaved", "컴퓨터 간 동기화를 껐습니다. 공유 폴더의 파일은 유지됩니다.", "Computer sync is off. Files in the shared folder are kept.", "コンピューター間同期をオフにしました。共有フォルダーのファイルは保持されます。", "已关闭电脑间同步，共享文件夹中的文件会保留。"),
            L("SyncSettingFailed", "동기화 설정을 저장하지 못했습니다.", "Could not save sync settings.", "同期設定を保存できませんでした。", "无法保存同步设置。"),
            L("SyncFolderNotDirectory", "파일은 동기화 위치로 사용할 수 없습니다. 폴더를 선택해 주세요.", "A file cannot be used as a sync location. Choose a folder.", "ファイルは同期場所として使用できません。フォルダーを選択してください。", "文件不能用作同步位置，请选择文件夹。"),
            L("SyncFolderReadWriteUnavailable", "이 위치에서 파일을 만들거나 읽을 수 없습니다. 클라우드 앱의 연결과 권한을 확인해 주세요.", "Files cannot be created or read here. Check the cloud app connection and permissions.", "この場所ではファイルを作成または読み取れません。クラウドアプリの接続と権限を確認してください。", "无法在此位置创建或读取文件，请检查云应用连接和权限。"),
            L("SyncFolderRenameUnavailable", "이 위치에서는 파일 이름 변경이 정상적으로 동작하지 않아 동기화에 사용할 수 없습니다.", "File renaming does not work correctly here, so this location cannot be used for syncing.", "この場所ではファイル名の変更が正常に動作しないため、同期には使用できません。", "此位置无法正常重命名文件，因此不能用于同步。"),
            L("SyncFolderContentMismatch", "이 위치에서 저장한 파일 내용이 달라졌습니다. 다른 동기화 폴더를 선택해 주세요.", "File content changed after writing. Choose another sync folder.", "この場所に保存したファイルの内容が変わりました。別の同期フォルダーを選択してください。", "写入此位置后的文件内容发生变化，请选择其他同步文件夹。"),
            L("SyncStateDisabled", "동기화 꺼짐", "Sync is off", "同期オフ", "同步已关闭"),
            L("SyncStateWaiting", "동기화 대기 중", "Waiting to sync", "同期を待機中", "等待同步"),
            L("SyncStateMigrating", "사진과 링크를 모바일에서 볼 수 있는 형식으로 준비 중", "Preparing photos and links for cloud preview", "写真とリンクをクラウドで表示できる形式に準備中", "正在将图片和链接准备为可在云端预览的格式"),
            L("SyncStateRecovering", "클라우드 데이터가 삭제되거나 교체되어 이 컴퓨터의 보관함으로 복구 중", "Cloud data was deleted or replaced. Rebuilding it from this computer", "クラウドデータが削除または置換されたため、このパソコンのライブラリから復元中", "云端数据已被删除或替换，正在使用此电脑的收藏库恢复"),
            L("SyncStateSyncing", "동기화 중", "Syncing", "同期中", "正在同步"),
            L("SyncStateSucceeded", "최근 동기화 완료", "Sync completed recently", "最近の同期が完了しました", "最近同步已完成"),
            L("SyncStateFolderUnavailable", "폴더를 사용할 수 없습니다. 클라우드 앱과 경로를 확인해 주세요", "Folder unavailable. Check the cloud app and folder path", "フォルダーを使用できません。クラウドアプリとパスを確認してください", "无法使用文件夹，请检查云应用和文件夹路径"),
            L("SyncStateInvalidData", "공유 폴더에서 손상되거나 충돌한 동기화 파일을 발견했습니다", "A damaged or conflicting sync file was found", "共有フォルダーで破損または競合した同期ファイルが見つかりました", "共享文件夹中发现损坏或冲突的同步文件"),
            L("SyncStateFailed", "동기화하지 못했습니다. 잠시 후 다시 시도합니다", "Sync failed. Sentory will retry shortly", "同期できませんでした。しばらくしてから再試行します", "同步失败，Sentory 稍后会重试"),
            ...
            L("CheckForUpdates", "수동 업데이트 확인", "Manual update check", "手動アップデート確認", "手动检查更新"),
            L("CheckForUpdatesDescription", "자동 확인 대기 시간과 관계없이 새 버전을 확인합니다", "Check for a new version without waiting for the automatic interval", "自動確認の待機時間に関係なく新しいバージョンを確認します", "无需等待自动检查间隔即可检查新版本"),
            L("CheckNow", "지금 확인", "Check now", "今すぐ確認", "立即检查"),
            L("CheckingForUpdates", "업데이트를 확인하고 있습니다.", "Checking for updates.", "アップデートを確認しています。", "正在检查更新。"),
            L("AppIsUpToDate", "현재 최신 버전을 사용하고 있습니다.", "Sentory is up to date.", "現在、最新バージョンを使用しています。", "当前已是最新版本。"),
            L("UpdateReadyFormat", "{0} 업데이트를 설치할 수 있습니다.", "Update {0} is ready to install.", "{0} アップデートをインストールできます。", "可以安装 {0} 更新。"),
            L("UpdateCheckFailed", "업데이트를 확인하지 못했습니다. 네트워크 연결을 확인해 주세요.", "Could not check for updates. Check your network connection.", "アップデートを確認できませんでした。ネットワーク接続を確認してください。", "无法检查更新，请检查网络连接。"),
            ...
            L("Tagline", "이야기 속, 흩어진 순간들을 한 곳에", "Moments scattered across your conversations, all in one place", "会話に散らばる瞬間を、一か所に", "将散落在对话中的瞬间汇聚一处"),
            ...
            L("KakaoTalk", "KakaoTalk", "KakaoTalk", "KakaoTalk", "KakaoTalk"),
            ...
            L("SavedOnSend", "전송 시 저장됨", "Saved on send", "送信時に保存", "发送时保存"),
            ...
            L("SlackDetectionEnabled", "Slack 감지를 켰습니다.", "Slack detection is on.", "Slack 検出をオンにしました。", "已开启 Slack 检测。"),
            L("SlackDetectionDisabled", "Slack 감지를 껐습니다.", "Slack detection is off.", "Slack 検出をオフにしました。", "已关闭 Slack 检测。"),
            L("SlackSettingFailed", "Slack 감지 설정을 저장하지 못했습니다.", "Could not save the Slack detection setting.", "Slack 検出設定を保存できませんでした。", "无法保存 Slack 检测设置。"),
            L("WhatsAppDetectionEnabled", "WhatsApp 감지를 켰습니다.", "WhatsApp detection is on.", "WhatsApp 検出をオンにしました。", "已开启 WhatsApp 检测。"),
            L("WhatsAppDetectionDisabled", "WhatsApp 감지를 껐습니다.", "WhatsApp detection is off.", "WhatsApp 検出をオフにしました。", "已关闭 WhatsApp 检测。"),
            L("WhatsAppSettingFailed", "WhatsApp 감지 설정을 저장하지 못했습니다.", "Could not save the WhatsApp detection setting.", "WhatsApp 検出設定を保存できませんでした。", "无法保存 WhatsApp 检测设置。"),
            L("TelegramDetectionEnabled", "Telegram 감지를 켰습니다.", "Telegram detection is on.", "Telegram 検出をオンにしました。", "已开启 Telegram 检测。"),
            L("TelegramDetectionDisabled", "Telegram 감지를 껐습니다.", "Telegram detection is off.", "Telegram 検出をオフにしました。", "已关闭 Telegram 检测。"),
            L("TelegramSettingFailed", "Telegram 감지 설정을 저장하지 못했습니다.", "Could not save the Telegram detection setting.", "Telegram 検出設定を保存できませんでした。", "无法保存 Telegram 检测设置。"),
            L("LineDetectionEnabled", "LINE 감지를 켰습니다.", "LINE detection is on.", "LINE 検出をオンにしました。", "已开启 LINE 检测。"),
            L("LineDetectionDisabled", "LINE 감지를 껐습니다.", "LINE detection is off.", "LINE 検出をオフにしました。", "已关闭 LINE 检测。"),
            L("LineSettingFailed", "LINE 감지 설정을 저장하지 못했습니다.", "Could not save the LINE detection setting.", "LINE 検出設定を保存できませんでした。", "无法保存 LINE 检测设置。"),
            L("WeChatDetectionEnabled", "WeChat 감지를 켰습니다.", "WeChat detection is on.", "WeChat 検出をオンにしました。", "已开启微信检测。"),
            L("WeChatDetectionDisabled", "WeChat 감지를 껐습니다.", "WeChat detection is off.", "WeChat 検出をオフにしました。", "已关闭微信检测。"),
            L("WeChatSettingFailed", "WeChat 감지 설정을 저장하지 못했습니다.", "Could not save the WeChat detection setting.", "WeChat 検出設定を保存できませんでした。", "无法保存微信检测设置。"),
            ...
            L("SlackNotInUse", "Slack 감지를 사용하지 않습니다", "Slack detection is disabled", "Slack 検出を使用していません", "Slack 检测已关闭"),
            L("WhatsAppNotInUse", "WhatsApp 감지를 사용하지 않습니다", "WhatsApp detection is disabled", "WhatsApp 検出を使用していません", "WhatsApp 检测已关闭"),
            L("TelegramNotInUse", "Telegram 감지를 사용하지 않습니다", "Telegram detection is disabled", "Telegram 検出を使用していません", "Telegram 检测已关闭"),
            L("LineNotInUse", "LINE 감지를 사용하지 않습니다", "LINE detection is disabled", "LINE 検出を使用していません", "LINE 检测已关闭"),
            L("WeChatNotInUse", "WeChat 감지를 사용하지 않습니다", "WeChat detection is disabled", "WeChat 検出を使用していません", "微信检测已关闭"),
            ...
            L("StatusDetectingMessengers", "상태: 메신저를 감지하고 있습니다.", "Status: Detecting messengers.", "状態: メッセンジャーを検出しています。", "状态：正在检测聊天应用。"),
            ...
            L("AutomaticReconnectHeading", "Discord를 자동으로 다시 연결합니다", "Discord will reconnect automatically", "Discord を自動で再接続します", "Discord 将自动重新连接"),
            L("AutomaticReconnectMessageFormat", "현재 실행 중인 Discord에서는 감지 연결을 준비하지 못했습니다. 작성 중인 메시지와 진행 중인 통화가 종료될 수 있습니다.\n\n{0}초 후 Discord를 다시 시작합니다.", "Detection could not connect to the running Discord process. Draft messages and active calls may be ended.\n\nDiscord will restart in {0} seconds.", "現在実行中の Discord では検出接続を準備できませんでした。作成中のメッセージや通話が終了する場合があります。\n\n{0}秒後に Discord を再起動します。", "无法连接当前运行的 Discord 进程。正在编辑的消息和通话可能会结束。\n\nDiscord 将在 {0} 秒后重新启动。"),
            L("RestartNow", "지금 재시작", "Restart now", "今すぐ再起動", "立即重新启动"),
            ...
            L("AutoFavoriteAdded", "복사하고 즐겨찾기에 자동으로 추가했습니다.", "Copied and automatically added to favorites.", "コピーして自動的にお気に入りへ追加しました。", "已复制并自动添加到收藏。"),
            L("AutoFavoriteAddFailed", "복사했지만 자동 즐겨찾기에 추가하지 못했습니다.", "Copied, but could not automatically add to favorites.", "コピーしましたが、自動でお気に入りに追加できませんでした。", "已复制，但无法自动添加到收藏。"),
            L("AutoFavoriteDisabled", "자동 즐겨찾기를 사용하지 않습니다.", "Automatic favorites are disabled.", "自動お気に入りを使用しません。", "已关闭自动收藏。"),
            L("AutoFavoriteSavedFormat", "{0}회 반복 사용하면 자동으로 즐겨찾기에 추가합니다.", "Items will be added to favorites after {0} repeated uses.", "{0}回繰り返し使用すると自動的にお気に入りへ追加します。", "重复使用 {0} 次后将自动添加到收藏。"),
            L("AutoFavoriteSaveFailed", "자동 즐겨찾기 설정을 저장하지 못했습니다.", "Could not save the automatic favorites setting.", "自動お気に入りの設定を保存できませんでした。", "无法保存自动收藏设置。"),
