...
internal static class SentoryLocalization
{
    ...
    private static IReadOnlyDictionary<string, LocalizedText> CreateTexts()
    {
        var entries = new LocalizedText[]
        {
            ...
            L("UpdateAvailableMessage", "새 버전 {0}을 설치할 수 있습니다.\n\n{1}", "Version {0} is ready to install.\n\n{1}", "新しいバージョン {0} をインストールできます。\n\n{1}", "可以安装新版本 {0}。\n\n{1}"),
            ...
            L("CopyrightNotice", "Copyright © 2026 NudeNyang. All rights reserved.", "Copyright © 2026 NudeNyang. All rights reserved.", "Copyright © 2026 NudeNyang. All rights reserved.", "Copyright © 2026 NudeNyang. All rights reserved."),
            L("LicenseSummary", "개인적·비상업적 용도로만 이용 가능", "Personal, non-commercial use only", "個人的・非商用目的でのみ利用できます", "仅限个人非商业用途"),
            L("ViewLicense", "라이선스 보기", "View license", "ライセンスを見る", "查看许可协议"),
            L("LicenseTitle", "Sentory 라이선스", "Sentory License", "Sentory ライセンス", "Sentory 许可协议"),
            L("LicenseHeading", "개인 사용 라이선스", "Personal Use License", "個人利用ライセンス", "个人使用许可协议"),
            L("LicenseDescription", "Sentory의 사용 권한과 제한 사항", "Permissions and restrictions for Sentory", "Sentory の利用許諾と制限事項", "Sentory 的使用权限与限制"),
            ...
            L("DiscordPrepareHeading", "Discord 연결을 한 번 준비해 주세요", "Set up Discord connection once", "Discord 接続を一度設定してください", "请先完成一次 Discord 连接设置"),
            L("DiscordPrepareDescription", "Discord를 접근성 모드로 다시 시작하면 링크와 사진 전송을 확인할 수 있습니다.", "Restart Discord in accessibility mode to detect sent links and photos.", "Discord をアクセシビリティモードで再起動すると、リンクと写真の送信を確認できます。", "以无障碍模式重启 Discord 后即可检测已发送的链接和图片。"),
            ...
            L("DiscordReconnect", "Discord 다시 연결", "Reconnect Discord", "Discord を再接続", "重新连接 Discord"),
