...
internal static class SentoryLocalization
{
    ...
    private static IReadOnlyDictionary<string, LocalizedText> CreateTexts()
    {
        var entries = new LocalizedText[]
        {
            ...
            L("SyncAutomaticLocationFormat", "{0}에 Sentory 폴더를 자동으로 만듭니다", "Sentory will create its folder in {0} automatically", "{0} に Sentory フォルダーを自動で作成します", "将在 {0} 中自动创建 Sentory 文件夹"),
            L("SyncProviderSelectionDescription", "동기화에 사용할 클라우드를 선택하세요", "Choose the cloud service to use for syncing", "同期に使用するクラウドを選択してください", "请选择用于同步的云服务"),
            ...
            L("SelectSyncFolder", "폴더 선택", "Choose folder", "フォルダーを選択", "选择文件夹"),
