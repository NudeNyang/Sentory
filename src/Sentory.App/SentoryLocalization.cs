...
internal static class SentoryLocalization
{
    ...
    private static IReadOnlyDictionary<string, LocalizedText> CreateTexts()
    {
        var entries = new LocalizedText[]
        {
            ...
            L("ComputerSync", "컴퓨터 간 동기화", "Computer sync", "コンピューター間同期", "电脑间同步"),
            L("ComputerSyncHeading", "사진과 링크 공유", "Share photos and links", "写真とリンクを共有", "共享图片和链接"),
            ...
            L("SyncAutomaticLocationUnavailable", "클라우드 위치를 자동으로 찾지 못했습니다. 시작하면 동기화 폴더를 선택할 수 있습니다", "No cloud location was found automatically. You can choose a synced folder after starting", "クラウドの場所を自動検出できませんでした。開始すると同期フォルダーを選択できます", "未能自动找到云端位置。开始后可选择同步文件夹"),
